...
Would you like to authorize an application lock for rent-to-own, cash buy, or standard financing options? I can submit these configurations to the underwriters portal instantly!`;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      <div id="calculator-section" className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-white light:text-neutral-900">
        
        {/* Simulation/Controls Panel */}
        <div className="lg:col-span-7 bg-neutral-900/80 light:bg-white border border-neutral-800 light:border-neutral-200 rounded-2xl p-6 sm:p-8 backdrop-blur shadow-2xl relative overflow-hidden text-left flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-6">
                  ...
                  {CAR_MAKES.slice(0, 4).map((make) => (
                    <button
                      ...
                      className={`py-2 px-3 rounded-lg border text-xs font-medium flex flex-col items-center gap-1 transition-all ${
                        carMake === make.name
                          ? 'border-red-500 bg-red-950/20 text-white animate-pulse light:bg-red-100 light:text-neutral-900'
                          : 'border-neutral-800 bg-neutral-950/40 text-neutral-400 hover:border-neutral-700 hover:text-white light:bg-neutral-100 light:text-neutral-600 light:hover:border-neutral-300 light:hover:text-neutral-900'
                      }`}
                    >
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="flex items-center bg-neutral-950 light:bg-neutral-100 border border-neutral-800 light:border-neutral-300 rounded px-2 py-0.5 font-mono text-sm font-semibold text-red-500">
                ...
                <input
                  ...
                  className="w-full accent-red-500 h-1.5 bg-neutral-950 light:bg-neutral-200 rounded-lg appearance-none cursor-pointer"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full accent-red-500 h-1.5 bg-neutral-950 light:bg-neutral-200 rounded-lg appearance-none cursor-pointer"
                />
                <p className="text-[11px] text-neutral-400 light:text-neutral-600 mt-1.5 leading-relaxed bg-neutral-950/40 light:bg-neutral-100 p-2 border border-neutral-800/60 light:border-neutral-200 rounded font-medium">
                  ...
                  {LOAN_TERMS.map((m) => (
                    <button
                      ...
                      className={`py-2 rounded-lg border font-mono text-xs font-semibold text-center transition-all ${
                        term === m
                          ? 'border-red-500 bg-red-950/20 text-white shadow-md light:bg-red-100 light:text-neutral-900'
                          : 'border-neutral-800 bg-neutral-950/40 text-neutral-400 hover:border-neutral-700 hover:text-white light:bg-neutral-100 light:text-neutral-600 light:hover:border-neutral-300 light:hover:text-neutral-900'
                      }`}
                    >
                      {m}m
          ...
          <div className="mt-6 pt-4 border-t border-neutral-850 light:border-neutral-200 bg-neutral-950/30 light:bg-neutral-100 p-4 rounded-xl flex items-center justify-between gap-4">
            ...
            <button
              ...
              disabled={aiLoading}
              className="py-1.5 px-3 bg-red-950/40 hover:bg-red-900 light:bg-red-100 light:hover:bg-red-200 border border-red-500/30 light:border-red-300 text-red-400 light:text-red-700 hover:text-white light:hover:text-red-800 text-xs font-bold uppercase tracking-wider rounded-lg transition-all flex items-center gap-1"
            >
              {aiLoading ? (
                <>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="bg-gradient-to-br from-neutral-900 to-[#101010] light:bg-gradient-to-br light:from-white light:to-neutral-100 border border-neutral-800 light:border-neutral-200 rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-2xl relative overflow-hidden">
            
            {/* Header: Mode Switcher tabs */}
            <div className="space-y-4">
              <span className="text-[10px] tracking-widest font-bold text-red-500 uppercase bg-red-950/30 light:bg-red-100 border border-red-500/15 light:border-red-300 px-2.5 py-0.5 rounded-full">
                Interactive rate selector
              </span>

              {/* THREE-WAY TABS FOR RENT TO OWN vs CASH BUYOUT vs FINANCING */}
              <div className="grid grid-cols-3 gap-1 bg-neutral-950 light:bg-neutral-200 p-1 rounded-xl border border-neutral-850 light:border-neutral-200 font-display">
                <button
            ...
            <div className="my-6">
                ...
                <div className="space-y-5 text-left">
                  <div>
                    ...
                    <div className="flex items-baseline gap-1 mt-1">
                      <span className="text-4xl sm:text-5xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-r from-white via-red-200 to-red-400 light:from-neutral-900 light:via-red-600 light:to-red-700">
                  ...
                  <div className="grid grid-cols-2 gap-4 border-y border-neutral-800/80 light:border-neutral-200 py-4 font-mono text-xs">
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Offered APR</span>
                    ...
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Financed Principal</span>
                          <span className="font-semibold text-white light:text-neutral-900">₱{loanAmount.toLocaleString()}</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Terms Duration</span>
                          <span className="font-semibold text-neutral-300 light:text-neutral-700">{term} Months</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Total Interest paid</span>
                      <span className="font-semibold text-neutral-300 light:text-neutral-700">₱{totalInterest.toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
                    </div>
                  </div>

                  <div className="p-3 bg-neutral-950 light:bg-neutral-100 rounded-xl border border-neutral-850 light:border-neutral-200 flex items-start gap-2">
                    <Check className="w-3.5 h-3.5 text-green-500 shrink-0 mt-0.5" />
                    <p className="text-[10px] text-neutral-400 light:text-neutral-600 leading-normal">
              ...
              {acquisitionMode === 'RENT_TO_OWN' && (
                <div className="space-y-5 text-left font-sans">
                  ...
                  <div className="grid grid-cols-2 gap-4 border-y border-neutral-800/80 light:border-neutral-200 py-4 font-mono text-xs">
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Surcharge Rate Equivalent</span>
                      <span className="font-semibold text-red-400 flex items-center gap-1">
                        <Percent className="w-3.5 h-3.5 inline text-red-500" /> {rtoSurchargeRate}% APR
                      </span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Security deposit</span>
                          <span className="font-semibold text-white light:text-neutral-900">₱{Math.round(downPayment * 0.6).toLocaleString()}</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">RTO Contract term</span>
                          <span className="font-semibold text-neutral-300 light:text-neutral-700">{term} Months</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Convenience Premium</span>
                      <span className="font-semibold text-neutral-300 light:text-neutral-700">₱{Math.round(rtoPremiumFinanced).toLocaleString()}</span>
                    </div>
                  </div>

                  <div className="p-3 bg-[#1e1515] light:bg-red-100 rounded-xl border border-red-950/50 light:border-red-300 flex items-start gap-2">
                    <ShieldAlert className="w-4 h-4 text-red-500 shrink-0 mt-0.5 animate-pulse" />
                    <p className="text-[10px] text-neutral-400 light:text-neutral-600 leading-normal">
                      <strong className="text-white light:text-neutral-900 block uppercase text-[8px] tracking-wider mb-0.5 text-red-400">No Hard Credit Checks Required</strong>
              ...
              {acquisitionMode === 'CASH' && (
                <div className="space-y-5 text-left">
                  <div>
                    ...
                    <div className="flex items-baseline gap-1 mt-1">
                      <span className="text-4xl sm:text-5xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-r from-white via-green-200 to-green-400 light:from-neutral-900 light:via-green-600 light:to-green-700">
                  ...
                  <div className="grid grid-cols-2 gap-4 border-y border-neutral-800/80 light:border-neutral-200 py-4 font-mono text-xs">
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Financing APR</span>
                      <span className="font-semibold text-neutral-500">0.00% (None)</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Immediate Price Discount</span>
                      <span className="font-semibold text-green-400">-₱{(price * 0.05).toLocaleString()}</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Estimated Savings</span>
                      <span className="font-semibold text-green-400 font-bold">₱{Math.round(cashSavingsAmount).toLocaleString()} Total</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-neutral-500 light:text-neutral-600 block uppercase font-sans font-semibold mb-0.5">Vehicle Value Locked</span>
                          <span className="font-semibold text-white light:text-neutral-900">₱{price.toLocaleString()}</span>
                    </div>
                  </div>

                  <div className="p-3 bg-neutral-950 light:bg-neutral-100 rounded-xl border border-neutral-850 light:border-neutral-200 flex items-start gap-2">
                    <Check className="w-3.5 h-3.5 text-green-500 shrink-0 mt-0.5" />
                    <p className="text-[10px] text-neutral-400 light:text-neutral-600 leading-normal font-sans">
                      Eliminates periodic interest bills completely. Earn premium <span className="text-white light:text-neutral-900 font-semibold">5% cash discount rate</span> at procurement checkout.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="mt-4">
              <button
                ...
                className="w-full bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-semibold py-3 px-4 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 uppercase tracking-wider text-xs font-display hover:-translate-y-0.5"
              >
          ...
          <div className="bg-neutral-900 light:bg-white border border-neutral-800 light:border-neutral-200 rounded-2xl p-5 shadow-lg text-left">
            <h3 className="text-xs font-bold tracking-wider text-neutral-400 light:text-neutral-600 uppercase mb-3 font-display">Acquisition Category baseline Projections</h3>
            <div className="space-y-2.5 font-sans">
              <div className="flex justify-between items-center p-2 bg-neutral-950 light:bg-neutral-100 rounded-lg border border-neutral-800 light:border-neutral-200">
                <div>
                  <span className="text-xs font-bold text-white light:text-neutral-900 block">Cash Unit Savings Rate</span>
              ...
              <div className="flex justify-between items-center p-2 bg-neutral-950 light:bg-neutral-100 rounded-lg border border-neutral-800 light:border-neutral-200">
                <div>
                  <span className="text-xs font-bold text-white light:text-neutral-900 block">Financing Base Interest Rate</span>
              ...
              <div className="flex justify-between items-center p-2 bg-neutral-950 light:bg-neutral-100 rounded-lg border border-neutral-800 light:border-neutral-200">
                <div>
                  <span className="text-xs font-bold text-white light:text-neutral-900 block">Rent-to-Own Program Premium</span>
      ...
      {(aiLoading || aiAnalysis || aiError) && (
        <div className="bg-neutral-900/90 light:bg-white border border-neutral-800 light:border-neutral-200 rounded-3xl p-6 sm:p-8 text-left shadow-2xl relative overflow-hidden transition-all duration-350">
          <div className="absolute top-0 right-0 w-64 h-64 bg-red-600/5 blur-3xl rounded-full" />
          
            <div className="flex items-center justify-between border-b border-neutral-830 light:border-neutral-200 pb-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-red-950/40 border border-red-500/20 text-red-500 rounded-xl">
                <BrainCircuit className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <div>
                <h3 className="text-base sm:text-lg font-bold font-display text-white light:text-neutral-900">Underwriting AI Acquisition Suite</h3>
                <p className="text-[10px] text-neutral-400 font-mono">llama-3.3-70b-versatile : Groq Inference</p>
              </div>
            </div>

              <span className="text-[10px] text-red-500 border border-red-500/30 light:border-red-300 px-2 py-0.5 rounded-full uppercase tracking-wider font-mono bg-red-950/20 light:bg-red-100 font-bold hidden sm:inline">
                Rate Intelligence
              </span>
          </div>
          ...
          {aiThinking && (
            <details className="mb-6 bg-neutral-950/50 light:bg-neutral-100 border border-neutral-850 light:border-neutral-200 rounded-xl overflow-hidden" open>
              <summary className="cursor-pointer text-[10px] font-semibold text-neutral-400 light:text-neutral-600 hover:text-red-400 light:hover:text-red-600 p-3 select-none flex items-center gap-2 bg-neutral-950 light:bg-neutral-100">
              ...
              <div className="p-4 border-t border-neutral-900 light:border-neutral-200 bg-neutral-950/90 light:bg-neutral-50 font-mono text-[10px] text-red-250/70 light:text-neutral-700 whitespace-pre-line leading-relaxed max-h-[160px] overflow-y-auto">
                {aiThinking}
              </div>
            </details>
          )}
          ...
          {aiLoading ? (
            <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-xs sm:text-sm font-semibold text-neutral-200 light:text-neutral-700">AI Counselor is constructing dynamic matrices...</p>
                <p className="text-[10px] text-neutral-500 font-mono">Running side-by-side rates projection for {carMake} {carModel}</p>
              </div>
            </div>
          ) : aiError ? (
            <div className="p-4 bg-red-950/20 light:bg-red-100 border border-red-500/20 light:border-red-300 rounded-xl flex items-center gap-3 text-red-400 light:text-red-700 text-xs my-4">
              <AlertCircle className="w-5 h-5 text-red-500 shrink-0" />
              <span>{aiError}</span>
            </div>
          ) : (
            <div className="prose prose-invert max-w-none text-xs sm:text-sm leading-relaxed text-neutral-300 light:text-neutral-700 font-sans space-y-4 select-text">
              {aiAnalysis.split('\n').map((line, idx) => {
                ...
                if (cleanLine.startsWith('### ')) {
                  return (
                    <h3 key={idx} className="text-sm sm:text-base font-bold font-display text-white light:text-neutral-900 mt-6 mb-2 border-b border-neutral-800 light:border-neutral-200 pb-1 flex items-center gap-2">
                ...
                if (cleanLine.match(/^\d+\./)) {
                  return (
                    <div key={idx} className="bg-neutral-950 light:bg-neutral-100 border border-neutral-850 light:border-neutral-200 p-4 rounded-xl mt-4 space-y-2 text-left relative overflow-hidden">
                      <div className="absolute right-0 top-0 bottom-0 w-1 bg-red-600" />
                      <p className="font-semibold text-white light:text-neutral-900 text-xs sm:text-sm">{cleanLine}</p>
                    </div>
                  );
                }
          ...
          <div className="mt-8 pt-4 border-t border-neutral-820 light:border-neutral-200 flex justify-between items-center text-left text-[10px] text-neutral-500">
